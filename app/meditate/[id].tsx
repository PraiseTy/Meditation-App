                ...
                <AppGradient colors={["transparent", "rgba(0,0,0,0.8)"]}>
                    ...
                    <View className='flex-1 justify-center'>
                        <View className='mx-auto bg-neutral-200 rounded-full w-44 h-44 justify-center items-center'>
                            <Text
                                className='text-4xl text-blue-800 font-rmono'>{formattedTimeMinutes}:{formattedTimeSeconds}</Text>
                        </View>
                    </View>

                    <View className='mb-5'>
                        <CustomButton onPress={handleAdjustDuration}
                                      title="Adjust Duration"/>
                        <CustomButton onPress={toggleMeditationSessionStatus}
                                      title={isMeditating ? 'Stop Meditating' : 'Start Meditating'} containerStyle="mt-4"/>
                    </View>
                </AppGradient>
            </ImageBackground>
        </View>
